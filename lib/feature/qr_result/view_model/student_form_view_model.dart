...
import '../../qr_result/model/student_qr_data.dart';
import '../../qr_result/view/qr_result_screen.dart';
...
class StudentFormViewModel {
  ...
  void generateQr(BuildContext context) {
    ...
    final studentData = StudentQrData(
      name: name,
      id: id,
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => QrResultScreen(data: studentData),
      ),
    );
  }
}